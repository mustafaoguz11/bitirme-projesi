...
import 'pages/competitions/competitions_page.dart';
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      routes: {
        ...
        '/yarismalar': (context) => const CompetitionsPage(),
      },
      initialRoute: '/welcome',
      theme: ThemeData(
        colorScheme: ColorScheme.fromSeed(seedColor: Color.fromARGB(255, 30, 255, 0)),
        useMaterial3: true,
      ),
    );
  }
